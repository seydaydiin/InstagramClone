package com.seydaaydin.instagramclonejava.adapter;
...
import com.seydaaydin.instagramclonejava.databinding.RecyclerRowBinding;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostHolder> {
 ...
 Picasso.get().load(postArrayList.get(position).downloadUrl).into(holder.recyclerRowBinding.reclerViewImageView);
